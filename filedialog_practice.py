...
def separate_spleeter():
    player.withdraw
    os.mkdir('\spleeter')
    file_song = filedialog.askopenfile()
    seperator = Separator('spleeter:2stems')
    seperator.separate_to_file(file_song,'\spleeter' )
...
button6 = tkr.Button(player, width= 5, height =3, text="spleet", command=separate_spleeter)
